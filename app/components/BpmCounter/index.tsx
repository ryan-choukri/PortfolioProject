	...
	return (
		<div className="min-h-screen flex items-center justify-center ">
			<div className="w-full max-w-sm bg-zinc-800 rounded-2xl border border-zinc-700 shadow-xl p-6 flex flex-col items-center gap-6">
				...
				<button
					onClick={handleClick}
					className="w-full h-24 rounded-xl bg-yellow-500 text-white text-2xl font-bold tracking-wide active:scale-95 hover:bg-yellow-600 transition-all shadow-lg"
				>
					TAP
				</button>
