...
const KeyboardGame = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col pt-8">
      ...
      {/* Game Area */}
      <div className="mb-6 flex flex-col items-center space-y-4 px-4 sm:px-8 lg:px-8">
        {/* Text to type */}
        {gameActive && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
          <div className="w-full max-w-md rounded-lg border border-white/20 bg-gray-900 p-8 text-center">
            ...
            <div className="mb-6 space-y-2 text-gray-300">
              <p>
                Temps écoulé : <span className="font-bold text-blue-400">{((1000 - timer) / 10).toFixed(1)}s</span>
              </p>
              <p>
