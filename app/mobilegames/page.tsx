          ...
          <div className="grid items-center gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <span className="inline-block rounded-full bg-blue-900 px-3 py-1 text-sm font-medium text-blue-300">Jeu Mobile</span>
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <button className="flex items-center justify-center space-x-2 rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white transition-colors duration-200 hover:bg-blue-700">
                  <span>📱</span>
              ...
              <div className="iphone-display text-center">
                ...
                <IPhoneMockup frameColor={'#3f3f3f'} isLandscape frameOnly hideStatusBar screenWidth={350}>
                  ...
                  <Image
                    width={350}
                    height={700}
                    src="https://images.unsplash.com/photo-1650963310446-011fc6a28367?q=80&w=2232&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Screenshot du jeu Tout va bien"
                  />
                </IPhoneMockup>
