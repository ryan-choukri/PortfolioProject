...
export function Waves({
  className = '',
  strokeColor = '#111828', // White lines
  backgroundColor = 'rgba(0, 7, 31, 0.2)', // Black background
  pointerSize = 0.5,
}: WavesProps) {
  ...
  const setLines = () => {
    ...
    const xGap = 16; // Reduced horizontal spacing
    const yGap = 16; // Reduced vertical spacing for denser points
  ...
  return (
    <div
      ref={containerRef}
      className={`waves-component relative z-1 overflow-hidden ${className}`}
      style={
        {
          zIndex: -1,
          backgroundColor,
      ...
      <svg ref={svgRef} className="js-svg block h-full w-full" xmlns="http://www.w3.org/2000/svg" />
      <div
